    ...
    if (userRole === ROLES.SUPER_ADMIN || userRole === ROLES.ADMIN) {
      baseNavigation.push({
        ...
        children: [
          ...
          { name: 'Suppliers', href: '/dashboard/organization/suppliers', current: pathname.startsWith('/dashboard/organization/suppliers') },
          { name: 'Customers', href: '/dashboard/organization/customers', current: pathname.startsWith('/dashboard/organization/customers') },
          { name: 'Materials', href: '/dashboard/organization/materials', current: pathname.startsWith('/dashboard/organization/materials') },
