...
export default function SuppliersPage() {
  ...
  const fetchSuppliers = async () => {
    try {
      const res = await fetch('/api/organization/suppliers')
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => router.push('/dashboard/organization/suppliers/create')}>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {suppliers.map((supplier) => (
                  <tr key={supplier.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{supplier.registrationNo || '-'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button 
                        onClick={() => router.push(`/dashboard/organization/suppliers/${supplier.id}/edit`)}
