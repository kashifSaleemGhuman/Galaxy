...
export default function DocumentDetailsPage() {
  ...
  const handleEdit = (doc) => {
    ...
    if (doc.name === 'EACH ROLE RISK ASSESSMENT') {
      router.push('/dashboard/organization/each-role-risk-assessment')
      return
    }
    ...
    if (doc.name === 'Induction Assessment Program') {
      router.push('/dashboard/organization/induction-assessment-program')
      return
    }
