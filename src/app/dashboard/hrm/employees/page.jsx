...
export default function HRMEmployeesPage() {
  ...
  const canViewCredentials = isSuperAdmin || isHRManager

  const breadcrumbs = [
    { key: 'dashboard', label: 'Dashboard', href: '/dashboard' },
    { key: 'hrm', label: 'HRM', href: '/dashboard/hrm' },
    { key: 'employees', label: 'Employees', href: '/dashboard/hrm/employees' },
  ]
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => router.push('/dashboard/hrm/employees/create')}>
                  ...
                  <tr key={employee.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        <button 
                          onClick={() => router.push(`/dashboard/hrm/employees/${employee.id}/edit`)}
